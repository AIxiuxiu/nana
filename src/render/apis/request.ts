...
const baseURL = !isElectronApp && import.meta.env.VITE_OPEN_PROXY === 'true' ? '/proxy/' : import.meta.env.VITE_APP_API_BASEURL?.toString();
...
http.interceptors.request.use(
  (config: AxiosRequestConfig) => {
    const token = !isElectronApp && import.meta.env.DEV && import.meta.env.VITE_APP_TOKEN ? import.meta.env.VITE_APP_TOKEN : storage.get('token');
    if (token) {
