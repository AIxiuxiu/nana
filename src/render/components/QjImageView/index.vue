...
import { useSendDownloadFile } from '@/hooks/useSendIpc';
import { rafThrottle } from '@/utils';
import { ArrowLeft, ArrowRight, Close, Download, FullScreen, RefreshLeft, RefreshRight, ScaleToOriginal, ZoomIn, ZoomOut } from '@element-plus/icons';
import { useEventListener } from '@vueuse/core';
import type { CSSProperties } from 'vue';
import { PropType, computed, effectScope, nextTick, onMounted, ref, shallowRef, watch } from 'vue';
...
const mode = shallowRef(Mode.CONTAIN);
const transform = ref({
  scale: 1,
  deg: 0,
  offsetX: 0,
...
function registerEventListener() {
  ...
  const mousewheelHandler = rafThrottle((e: WheelEvent | any /* TODO: wheelDelta is deprecated */) => {
...
function handleDownLoad() {
  useSendDownloadFile(currentImg.value);
}
</script>
