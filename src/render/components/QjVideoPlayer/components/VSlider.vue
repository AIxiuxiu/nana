<template>
  <div ref="refSlider" class="d-slider" :class="{ 'is-vertical': props.vertical }" @mousedown.stop="mouseDownHandle" @contextmenu="contextmenuHandle">
    <div class="d-slider__runway" @mousemove="mousemoveHandle">
      <div v-show="props.hover" class="d-slider__cursor" :style="hoverStyle">
        <div v-show="props.hoverText" ref="refTips" class="d-slider__tips" :style="{ left: state.hoverTipsLeft }">{{ props.hoverText }}</div>
      </div>
